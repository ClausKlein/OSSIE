...
class OSSIECF_API FileManager_impl:public virtual POA_CF::FileManager,  public FileSystem_impl
{
 ...
 protected:
    ...
    CF::FileManager::MountType& getMountType (const char *_mountPoint);
    CF::FileManager::MountType& getMountTypeByFile (const char *_fullPath);
    char *
      getRelName (const char *_relPath);
