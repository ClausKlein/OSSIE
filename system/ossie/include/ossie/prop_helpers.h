...
namespace ossieSupport {
  ...
  CORBA::ULongLong strings_to_unsigned_long_long(std::vector<std::string> &values); // by RADMOR
  ...
  CORBA::ULongLongSeq *strings_to_unsigned_long_long_sequence(std::vector<std::string> &values); // by RADMOR
