...
protected:
    ...
    void parseElement();
    void parsePort(DOMElement * elem);
    void parseFindBy(DOMElement * elem);
    void parseComponentInstantiationRef(DOMElement * elem);
    void parseDeviceUsedByThisComponentRef(DOMElement * elem);
    void parseDeviceThatLoadedThisComponentRef(DOMElement * elem);
